...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String profileUrl = 'https://randomuser.me/api/portraits/men/32.jpg';
  ...
  void _loadUserInfo() {
    ...
    if (user != null) {
      setState(() {
        ...
        profileUrl = user.photoURL ?? 'https://randomuser.me/api/portraits/men/32.jpg';
      });
    }
  }
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 16),
                              _CircleIconButton(icon: Icons.settings, onTap: _navigateToSettings),
                              const SizedBox(width: 16),
                              _CircleIconButton(icon: Icons.logout, onTap: _signOut),
                            ],
                          ),
                        ],
                      ),
